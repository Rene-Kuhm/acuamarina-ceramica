        ...
        <div className="flex h-16 items-center justify-between gap-4 px-4 sm:px-6">
          ...
          <div className="flex items-center gap-4 flex-1 min-w-0">
            ...
            <Button
              variant="ghost"
              size="icon"
              className="lg:hidden flex-shrink-0 h-10 w-10 rounded-xl text-slate-600 hover:text-slate-900 hover:bg-slate-100"
            ...
            <div className="flex-1 max-w-md lg:ml-8">
              <div className="relative group">
                ...
                <Input
                  ...
                  className="pl-10 h-10 w-full bg-slate-50 border-slate-200 rounded-xl text-sm placeholder:text-slate-400 focus:bg-white focus:border-teal-300 focus:ring-teal-500/20 transition-all"
                  disabled
                />
                <kbd className="hidden sm:inline-flex absolute right-3 top-1/2 -translate-y-1/2 h-5 px-1.5 items-center gap-1 rounded border border-slate-200 bg-white text-[10px] font-medium text-slate-400">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <Button
              variant="ghost"
              size="icon"
              className="hidden sm:flex h-10 w-10 rounded-xl text-slate-500 hover:text-slate-700 hover:bg-slate-100"
              title="Ayuda"
            >
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="relative h-10 w-10 rounded-xl text-slate-500 hover:text-slate-700 hover:bg-slate-100"
                >
