          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2 text-white-600">Calidad</h3>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2 text-white-600">Pasión</h3>
                <p className="text-gray-200">
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2 text-white-600">Confianza</h3>
                <p className="text-gray-200">
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2 text-white-600">Cercanía</h3>
                <p className="text-gray-200">
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2 text-white-600">Rapidez</h3>
                <p className="text-gray-200">
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2 text-white-600">Compromiso</h3>
                <p className="text-gray-200">
        ...
        <div className="bg-gradient-hero rounded-2xl p-12 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-white">Productos disponibles</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold mb-2">99%</div>
              <div className="text-white">Satisfacción del cliente</div>
            </div>
          </div>
        </div>
      </div>
